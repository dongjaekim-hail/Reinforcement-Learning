...
class Agent:
    ...
    def train(self, max_episodes=1000, render_episodes=100,max_step_per_ep=np.inf):
        for ep in range(max_episodes):
            ...
            while not (done or truncated):
                ...
                noise = self.ou_noise(bg_noise, dim=self.action_dim) # similar to epsilon greedy
...
def main():
    ...
    agent = Agent(env)
    agent.train(render_episodes = 100, max_step_per_ep = 10000)
